...
data = [([['2) -4024273668', 'https://t.me/+kaLhqGj2EHg3NjFi'], ['1) -4066133079', 'https://t.me/+OF5wBCw4OTsxZjMy']],), (None,)]
...
for element in data:
    if element:  # Проверка на None
        for subelement in element:
            if subelement:  # Проверка на None в подэлементе
