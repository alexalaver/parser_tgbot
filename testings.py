...
#
# print(result)
a = [[6960456010, 'Алекс привет как ваши дела аааа'], [6429580792, 'тима привет а аваши как дела']]

# Изменяем каждый подсписок в a, обрезая текст с 10 по 18 символы и добавляя "..."
modified_a = [[item[0], item[1][9:18] + '...'] for item in a]
