                                        ...
                                        if keyword.lower() in message.text.lower():
                                            ...
                                            if message_key not in messages_sent:
                                                ...
                                                if "bot" not in username.lower():
                                                    ...
                                                    if message_text in black_list_post or message.sender.id in black_list_id:
                                                        pass
                                                    else:
...
#                 if chat_ids != []:
#                     for chat_id, chat_id_name in zip(chat_idn, chat_names):
        ...
        if (not db.check_user(user_id)):
            ...
            if callback_query.message.chat.type == types.ChatType.PRIVATE:
                ...
                if black_list_button[0] == "black_list_add_username_button":
                    ...
                    await state.update_data(post_for_black_list_text=post_for_black_list_text)
                    await state.update_data(black_list_button=black_list_button)
                    markup = btn.confirm_black_list_button_post(black_list_button)
                    await callback_query.message.edit_text(text=cfg.black_list_post_confirm_text, reply_markup=markup)
                    ...
                    get_user_black_post = db.get_user_post_black_list(user_id, post_for_black_list_text)
                    if get_user_black_post == False:
                        ...
                        await callback_query.message.edit_text(text=cfg.black_list_post_confirm_right_text, reply_markup=None)
                    else:
                        await callback_query.message.edit_text(text=cfg.black_list_post_confirm_left_text, reply_markup=None)
                ...
                elif black_list_button[0] == "black_list_button":
                    post_for_black_list_text = callback_query.message.text
                    await state.update_data(post_for_black_list_text=post_for_black_list_text)
                ...
                elif black_list_button[0] == "back_from_black_list_all":
                    data = await state.get_data()
                    post_for_black_list_text = data.get("post_for_black_list_text")
                    markup = btn.button_black_list(black_list_button[1], black_list_button[2], black_list_button[3])
                    await callback_query.message.edit_text(text=post_for_black_list_text, reply_markup=markup)
                    ...
                    await callback_query.message.edit_text(text=cfg.select_user_black_list_text, reply_markup=markup)
                    ...
                    markup = btn.black_list_button_all(black_list_button[1], black_list_button[2], black_list_button[3])
                    await callback_query.message.edit_text(text=cfg.black_list_button_text, reply_markup=markup)
                elif black_list_button[0] == "select_post_black_list":
                    markup = btn.black_list_select_post_button(black_list_button[1], black_list_button[2], black_list_button[3], black_list_button[4])
                    await callback_query.message.edit_text(text=cfg.select_post_black_list_text, reply_markup=markup)
                elif black_list_button[0] == "back_from_delete_post":
                    posts_black_list_all = db.select_post_black_list_all(user_id)
                    markup = btn.black_list_posts_button_all(posts_black_list_all, black_list_button[1], black_list_button[2], black_list_button[3])
                    await callback_query.message.edit_text(text=cfg.black_list_button_post_text, reply_markup=markup)
                    ...
                    if db.select_post_black_list(user_id, post_id_black) == True:
                        db.delete_post_black_list(user_id, post_id_black)
                        await callback_query.message.edit_text(text=cfg.delete_post_from_black_list_text_right, reply_markup=None)
                    else:
                        await callback_query.message.edit_text(text=cfg.delete_post_from_black_list_text_left, reply_markup=None)
                elif black_list_button[0] == "delete_user_from_black_list":
                    user_id_black = black_list_button[1]
                    if db.select_user_black_list(user_id, user_id_black) == True:
                        db.delete_user_black_list(user_id, user_id_black)
                        await callback_query.message.edit_text(text=cfg.delete_user_from_black_list_text_right, reply_markup=None)
                    else:
                        await callback_query.message.edit_text(text=cfg.delete_user_from_black_list_text_left, reply_markup=None)
